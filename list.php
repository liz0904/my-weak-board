...
<body>
    <?php
    $connect = mysqli_connect('localhost', 'phpmyadmin', 'rootpass', 'formresponses') or die("connect failed");
    ...
    ?>
        <button onclick="location.href='./list.php'" style="float:right; font-size:15.5px;">로그인</button>
        <br />
    <?php
    }
    ?>
